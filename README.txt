...
test_question6.mlx ---- The calculation of functions f1(p), f2(p), f3(p), fw(p) and corresponding graphs about question 6(b)

EA.m ---- Main function of evolutionary algorithm used in question 4

EA_weighted_fitness.m ---- Main function of evolutionary algorithm applying linearly weighted fitness used in question 5(a)
